...
(function () {
        ...
        <div class="container">
          ...
          <div class="specialty-banner">
            <div class="specialty-banner-inner">
              ...
              <div>
                <span class="specialty-tag">${escapeHtml(s.category)}</span>
                <h1 style="margin-top:0.6rem">${escapeHtml(s.name)}</h1>
                <p>${escapeHtml(s.long)}</p>
              </div>
            </div>
          </div>
          <h2 style="font-family:var(--font-display);color:var(--accent);margin-bottom:1.25rem;font-size:1.4rem">
            مقالات في هذا المسار
          </h2>
          ${
            related.length
    ...
    return `
      <div class="page">
        <div class="container">
          ...
          <div class="coffee-notes" style="max-width:720px;margin:1rem auto 3rem">
            ${c.notes
              .map(
                (n) => `
          ...
          <div class="container">
            ...
            <div class="about-layout">
              <div class="about-card">
                ...
                <p style="color:var(--gold);font-family:var(--font-display);font-size:1.1rem;margin-top:1.25rem">
  ...
  /* تنقّل الروابط الداخلية */
  document.addEventListener("click", (e) => {
    const link = e.target.closest("[data-link]");
    if (!link) return;
    const href = link.getAttribute("href");
    if (href && href.startsWith("#")) {
      // hashchange سيتولى الرسم
      closeMenu();
    }
  });
